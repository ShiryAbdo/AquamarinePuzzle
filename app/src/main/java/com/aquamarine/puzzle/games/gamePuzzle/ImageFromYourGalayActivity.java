...
import static com.aquamarine.puzzle.games.R.id.action_refresh;
 import static com.aquamarine.puzzle.games.R.id.selectImage;
...
public class ImageFromYourGalayActivity extends AppCompatActivity implements MediaPlayer.OnCompletionListener,
    ...
    protected static final String FILENAME_DIR = "com.animals.puzzle.games";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setIcon(R.mipmap.fishicon);
